  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-3xl">
      ...
      <div className="text-sm text-gray-700 space-y-6 leading-relaxed">
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">2. 灵猫助手 AI 处理说明</h2>
          <p>当您使用首页的&quot;灵猫助手&quot;AI 功能时：</p>
          <ol className="list-decimal pl-6 mt-2 space-y-1">
            <li>您输入的文字消息会发送至我们配置的 AI 服务上游进行处理；</li>
            <li>您上传的附件会临时存储在服务器内存中（不写入磁盘、不写入数据库），用于本次会话提取文本或读取图片；</li>
            <li>当您发送图片并使用支持图片理解的模型时，图片内容会随本次请求发送至 AI 服务上游进行识别和回答；</li>
            <li>附件 30 分钟后自动从内存中清除；</li>
            <li>我们不持久化对话内容，关闭页面或刷新即清空当前会话；</li>
            <li>AI 输出仅供参考，不构成专业建议。重要文件请自行核验。</li>
          </ol>
        </section>

        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">3. 信息使用</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">4. 信息存储与安全</h2>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">5. 信息保留期限</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-xs border-collapse">
              ...
              <tbody>
                ...
                <tr><td className="border px-3 py-2">AI 助手附件</td><td className="border px-3 py-2">30 分钟内存 TTL，到期自动清除</td></tr>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">8. 用户权利</h2>
          <p>您有权：查看本站存储的您的个人信息；修改您的账号信息；删除您的使用历史记录；注销账号并删除所有个人数据；导出您的积分流水记录。如需行使上述权利，请联系：{siteConfig.email}。</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">9. 未成年人保护</h2>
          <p>本站不面向 16 岁以下未成年人提供服务。如果我们发现无意中收集了未成年人的信息，将立即删除。</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">10. 政策更新</h2>
          <p>本站可能不定期更新本隐私政策。重大变更时将在网站首页公告。继续使用本站服务即表示您接受更新后的政策。</p>
        </section>

        <section>
          <h2 className="text-base font-semibold text-gray-900 mb-3">11. 联系方式</h2>
